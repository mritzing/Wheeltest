...
public class wheeltest_datacollector extends PApplet {
...
public void handleError(Exception e) {
  ...
  public void settings() {  size(500, 175); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "wheeltest_datacollector" };
    if (passedArgs != null) {
